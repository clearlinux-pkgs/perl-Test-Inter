...
Source0  : https://cpan.metacpan.org/authors/id/S/SB/SBECK/Test-Inter-1.11.tar.gz
...
%prep
%setup -q -n Test-Inter-1.11
cd %{_builddir}/Test-Inter-1.11
pushd ..
cp -a Test-Inter-1.11 buildavx2
popd
